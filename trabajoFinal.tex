...
AD STUDEN DETAILS ordenado por STUDEN RE YEAR \\
A EXA RESULTS ordenado por STUDEN ID y COURS ID\\
A STUDEN ATTENDANCE ordenado por STUDEN ID\\
A DEPARTMENT ordenado por DEPARTMEN ID\\
    
     
     \item Muestre el porcentaje de iías que se han ausentado los alumnos y ordene los registros segun el porcentaje calculado.\\
   \item Muestre los 5 alumnos con la mayor calificacion y, a continuacion, los siguientes 5 alumnos, es decir, los clasificados del 6 al 10..
     \item Utilice WITH TIES para devolver todas las filas que tienen la misma clave de ordenacion que la ultima fila de la clausula de limitacion de filas cuando muestra 5 alumnos.
